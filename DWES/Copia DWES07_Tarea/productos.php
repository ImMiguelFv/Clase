...
// Cambios en creaFormularioProductos en productos.php
function creaFormularioProductos(){
  ...
  foreach ($productos as $p) {
      echo "<p><form id='form-" . $p->getcodigo() . "' action='productos.php' method='post'>";
...
// Cambios en muestraCestaCompra en productos.php
function muestraCestaCompra($cesta) {
    ...
    echo "<form id='form-vaciar' action='productos.php' method='post' onsubmit='return vaciarCesta();'>";
    ...
    echo "<form id='form-comprar' action='cesta.php' method='post' onsubmit='return muestraCesta();'>";
