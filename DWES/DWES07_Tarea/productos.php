...
function creaFormularioProductos()
{
  ...
  foreach ($productos as $p) {
    ...
    echo "<input type='submit' name='enviar' value='Añadir' id='" . "btn-" . $p->getcodigo() . "' onclick='anadeCesta(\"" . $p->getcodigo() ."\")'  />";
...
<head>
  ...
  <script type="text/javascript" src="fcesta.js" defer></script>
